// src/Lightfall.tsx
// WebGL "lightfall" background — falling glowing streaks with subtle mouse
// interaction. Adapted from React Bits (https://reactbits.dev) JS+CSS variant.
// Light TS typing wrap over the original implementation. Uses `ogl` for the
